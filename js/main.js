document.getElementById('year').textContent = new Date().getFullYear();
  ...
  const dict = {
    ru: {
      nav:{about:"О проекте", complexes:"Комплексы", house:"Дизайн дома", gallery:"Фото", contacts:"Контакты", cta:"Консультация"},
    ...
    uz: {
      nav:{about:"Loyiha haqida", complexes:"Majmualar", house:"Uy dizayni", gallery:"Foto", contacts:"Aloqa", cta:"Konsultatsiya"},
    ...
    en: {
      nav:{about:"About", complexes:"Complexes", house:"House Design", gallery:"Gallery", contacts:"Contact", cta:"Consultation"},
